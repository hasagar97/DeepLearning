...
#Defining Model
inp=layers.Input(shape=(300,400,3),name='input_layer')
...
en2 = layers.MaxPooling2D((2, 2), strides=(2, 2), name='block1_pool') (en1_1)

en3 = layers.Conv2D(filters=64,kernel_size=(3,3),activation='relu',name='conv3x3_en3', padding='same')(en2)
en3_1 = layers.Conv2D(filters=64,kernel_size=(3,3),activation='relu',name='conv3x3_en3_1', padding='same')(en3)
en4 = layers.MaxPooling2D((2, 2), strides=(2, 2), name='block2_pool') (en3_1)

en5 = layers.Conv2D(filters=128,kernel_size=(3,3),activation='relu',name='conv3x3_en5', padding='same')(en4)
en5_1 = layers.Conv2D(filters=128,kernel_size=(3,3),activation='relu',name='conv3x3_en5_1', padding='same')(en5)
en6 = layers.MaxPooling2D((2, 2), strides=(2, 2), name='block3_pool') (en5_1)
m=en3

de1=layers.Conv2DTranspose( 64 , kernel_size=(4,4) ,  strides=(2,2) , use_bias=False, padding='same',activation='relu'  )(en6)
...
add1=layers.Add()([ de2_2 , en4 ])
de3=layers.Conv2DTranspose( 32 , kernel_size=(4,4) ,  strides=(2,2) , use_bias=False, padding='same',activation='relu'  )(add1)
...
add2=layers.Add()([de3_2,en2])
de4 = layers.Conv2DTranspose( 16 , kernel_size=(4,4) ,  strides=(2,2) , use_bias=False, padding='same',activation='relu'  )(add2)
...
# In[18]:
# trainGen=image_generator(x_train,y_train, batch_size = 64)
# H = model.fit_generator(trainGen,steps_per_epoch=int(9000/64)	,epochs=2)
# model.fit(x=x_train,
         # y=yy,
         # batch_size=300,
         # epochs=1,
